...
try{
	...
	//generator.genUntexturedRandomClip(0, "../../data/json/config/config.0.json");
	...
	//generator.genTexturedRandomClip(0, "../../data/json/config/config.0.json");
	generator.genTexturedSequentClip(0, "../../data/json/config/config.1.json");
}
